...
export interface ApiClassBookingClassBooking
  ...
  attributes: {
    ...
    offering: Schema.Attribute.Enumeration<['In-person', 'Remote']> &
      Schema.Attribute.Required &
    ...
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Piano Lesson'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiInstructorInstructor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    class_bookings: Schema.Attribute.Relation<
      'oneToMany',
      'api::class-booking.class-booking'
    >;
    createdAt: Schema.Attribute.DateTime;
...
export interface ApiStudentStudent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    email: Schema.Attribute.Email;
    firstName: Schema.Attribute.String & Schema.Attribute.Required;
    hideSurname: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    lastName: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
